...
namespace editor
{
    ...
    export void RefreshPropertyPanel();
    export void RebuildRuntimeControls();
    export void RebuildHierarchyTree();
    export std::wstring HierarchyLabelForControl(const wui::ControlDef& c, int idx);
    export const std::vector<std::wstring>& TabPagesFor(const wui::ControlDef& tab);
    export void RebuildZOrderTree();
    export void SyncZOrderSelection();
    export void SyncHierarchySelection();
    export void UpdateZOrderButtons();
    export void RestackAndRefreshSelection();
    export void ApplyZOrderToWindows();
    export void EndDrag();
    export bool BeginCreateDrag(const POINT& designPt);
    export bool UpdateCreateDrag(const POINT& designPt);
    export void EndCreateDrag();
    export ParentInfo GetParentInfoFor(const wui::ControlDef& c);
    export HWND EnsureControlCreated(int index);
    export void EnsureTabPageContainers(int tabIndex);
    export RECT TabPageRectInDesignCoords(const wui::ControlDef& tabDef, HWND hTab);
    export void ShowArrangeContextMenu(POINT screenPt);
    export int NormalizedTabPage(int tabIndex, int requested);
    export LRESULT CALLBACK ZOrderTreeProc(HWND hwnd, UINT msg, WPARAM wp, LPARAM lp);
}
